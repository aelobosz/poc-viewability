 ...
 */
public class VideoAdNativeFragment extends Fragment implements ExoPlayer.EventListener {
	private static final String TAG = "VideoAdNativeFragment";
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.video_ad_native_detail, container, false);
		...
		try {
			adSession = AdSessionUtil.getNativeAdSession(getContext(), CUSTOM_REFERENCE_DATA, CreativeType.VIDEO);
...
// 3. Prepare the player with the source.
	...
	private static class ProgressRunnable implements Runnable {
		private final WeakReference<VideoAdNativeFragment> videoAdNativeFragmentWeakReference;

		ProgressRunnable(VideoAdNativeFragment videoAdNativeFragment) {
			this.videoAdNativeFragmentWeakReference = new WeakReference<>(videoAdNativeFragment);
		}

		@Override
		public void run() {
			VideoAdNativeFragment videoAdNativeFragment = videoAdNativeFragmentWeakReference.get();
